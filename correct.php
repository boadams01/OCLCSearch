...
$url="http://www.worldcat.org/webservices/catalog/search/worldcat/sru?query=" .  $dateparam . $subject . $maxrecords . $countparam .$sortparam .  $key;
...
echo "The number of records the API returned as MARCXML is " . $xmlstr->numberOfRecords . " (and I am going to try to process " . $numrecords . ")<br /><br /><hr />";
